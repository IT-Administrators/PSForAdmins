...
''
<#Windows has an implemented program to scan and fix datafiles in outlook, the directory of the file is not explicit, it depends on the os you are using, the office version you are using etc.

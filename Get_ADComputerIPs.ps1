...
Erroraction variable is used to prevent errormessages if the client domain is not present.
By uncommenting the select object behind the resolve cmdlet you can export the results to a csv file.#>

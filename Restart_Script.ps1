...
With the <StartScript> parameter you can call this function and specify your own script. 
The <ExecutionPolicy> parameter sets the execution policy. Default is bypass to run this on every device without changing 
